...
!================================================================================
  ...
  ! --- BAS
       call addfld_from(compatm, 'Sa_up2_sfc')
       call addfld_from(compatm, 'Sa_vp2_sfc')
  ! --- BAS
  ...
  ! --- BAS
          call addmap_from(compatm, 'Sa_up2_sfc', compocn, mapbilnr, 'one', atm2ocn_map)
          call addmap_from(compatm, 'Sa_vp2_sfc', compocn, mapbilnr, 'one', atm2ocn_map)
  ! --- BAS
