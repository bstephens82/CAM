...
!===============================================================================
  ...
  SUBROUTINE flux_atmOcn(logunit, nMax  ,zbot  ,ubot  ,vbot  ,thbot ,   &
       &               qbot,  rainc, up2_sfc, vp2_sfc, s16O  ,sHDO  ,s18O  ,rbot,  &  !BAS
       &               tbot  ,us    ,vs,  pslv,  &
  ...
  ! --- BAS
    logical, intent(in)    :: add_clubb_gusts
  ! --- BAS
  ...
  ! --- BAS
    real(R8)   ,intent(in) :: up2_sfc(nMax)
    real(R8)   ,intent(in) :: vp2_sfc(nMax)
  ! --- BAS
